export const projectData = [
  {
    ...
    tech: ['react', 'nodejs', 'express', 'mongodb', 'tailwind'],
  ...
  },
  {
    ...
    challenges: [
      'Organizing and displaying large datasets efficiently.',
      'Implementing powerful search and filtering capabilities.',
      'Optimizing image loading for ticketing galleries.',
      'Creating engaging narratives for each solution profile.'
    ],
    improvements: [
      'Add solution comparison tool.',
      'Implement industry filtering system.',
      'Add news feed for updates and events.',
      'Create interactive feature visualization.'
    ],
    links: {
