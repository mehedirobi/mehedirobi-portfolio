...
const EducationCard = ({ item, index }) => (
  <motion.div
    ...
    className="p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 border-l-4 transform hover:scale-105 bg-white dark:bg-gray-800 border-blue-400"
  >
    {/* Top Row */}
    <div className="flex justify-between items-start mb-4 flex-wrap gap-4">
      <div className="flex items-start gap-4 flex-1 min-w-0">
        ...
        <div className="min-w-0">
          <h3 className="text-xl font-bold hover:text-blue-500 transition-colors text-gray-900 dark:text-gray-100">
            {item.title}
          </h3>
          <p className="text-sm font-medium mt-1 text-gray-600 dark:text-gray-300">
            {item.institute}
          </p>
        </div>
      </div>
    ...
    <div className="flex flex-col gap-2 pl-10">
      <p className="text-sm font-medium text-gray-500 dark:text-gray-400">{item.year}</p>
...
export default function Education() {
  return (
    <section id="education" className="py-20 px-4 bg-gray-50 dark:bg-gray-900 transition-colors duration-500">
